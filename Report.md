...
![](include/Slide5.PNG)
Η πρώτη προσέγγιση δεσμεύει την περισσότερη μνήμη το οποίο είναι αναμενόμενο καθώς για κάθε token ενός κειμένου δεσμεύει 3 jobs (3 αναζητήσεις στα 3 ευρετήρια), ενώ η δεύτερη δεσμέυει ένα job για κάθε document όπως και η τρίτη με τη διαφορά ότι η τρίτη δεσμεύει ένα job και για κάθε start_query.
